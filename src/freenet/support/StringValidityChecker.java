...
public final class StringValidityChecker {
	 ...
	 */
	private static final HashSet<Character> idnBlacklist = new HashSet<>(Arrays.asList(
            new Character[]{
                    0x0020, /* SPACE */
	 ...
	 * Taken from http://en.wikipedia.org/w/index.php?title=Filename&oldid=344618757
	 */
	private static final HashSet<String> windowsReservedFilenames = new HashSet<>(Arrays.asList(
